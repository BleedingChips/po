...
void Simulate3D1ChannelFor2D4ChannelWrap(in uint2 index_2d, in uint4 simulate_size, 
...
void Simulate3D1ChannelFor2D4ChannelClamp(in uint2 index_2d, in uint4 simulate_size,
out uint3 index_3d_r, out uint3 index_3d_g, out uint3 index_3d_b, out uint3 index_3d_a)
{
    uint3 simulate_poi = uint3(
    index_2d.xy % (simulate_size.xy + 2),
    ...
    if (simulate_poi.y == 0)
        ...
        simulate_poi.y = simulate_size.x - 1;
    else
        simulate_poi.y -= 1;
